...
if(isset($_POST['submit22']))
{
	...
	if($lastInsertId)
	{
		$msg="<script>alert('Đã đặt thành công Bạn vui lòng đặt cọc 50% giá trị đến stk: xxxxx - ngân hàng VietComBank - Phạm Đức Duy  Hoặc đến văn phòng vé check-in trong 24h sau khi đặt tour. Nếu không hệ thống tự hủy!!!')</script>";
	}
	else 
	{
									...
									<div class="booking-form">
										...
										<form name="book" method="post" onsubmit = "return validateForm()">
											<h4> Mã tour:<b>  BKG-0<?php echo htmlentities($result->id_goi);?><b> </h4><br>
												...
												<p> Bạn vui lòng đặt cọc 50% giá trị đến stk: xxxxx - ngân hàng VietComBank - Phạm Đức Duy  Hoặc đến văn phòng vé check-in trong 24h sau khi đặt tour. Nếu không hệ thống tự hủy!!!</p>
												</div>
